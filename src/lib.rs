...
/// let hand = make_hand!(2s 3s 3s 4s 4s 8s 8s Wh Wh Wh { ankan E E E E });
/// assert_eq!(hand, Hand(
///     Tile37CountedMultiSet::new(&t![2s, 3s, 3s, 4s, 4s, 8s, 8s, Wh, Wh, Wh]),
///     [
...
macro_rules! make_hand {
	...
	($t1:tt $m1:tt $m2:tt $m3:tt $m4:tt) => {
		$crate::Hand::<1, 4>(
			$crate::Tile37CountedMultiSet::new(&$crate::t![$t1,]),
			[
	...
	($t1:tt $t2:tt $t3:tt $t4:tt $m1:tt $m2:tt $m3:tt) => {
		$crate::Hand::<4, 3>(
			$crate::Tile37CountedMultiSet::new(&$crate::t![$t1, $t2, $t3, $t4]),
			[
				$crate::make_hand!(@meld $m1),
				$crate::make_hand!(@meld $m2),
				$crate::make_hand!(@meld $m3),
	...
	($t1:tt $t2:tt $t3:tt $t4:tt $t5:tt $t6:tt $t7:tt $m1:tt $m2:tt) => {
		$crate::Hand::<7, 2>(
			$crate::Tile37CountedMultiSet::new(&$crate::t![$t1, $t2, $t3, $t4, $t5, $t6, $t7]),
			[
				$crate::make_hand!(@meld $m1),
				$crate::make_hand!(@meld $m2),
			],
	...
	($t1:tt $t2:tt $t3:tt $t4:tt $t5:tt $t6:tt $t7:tt $t8:tt $t9:tt $t10:tt $m1:tt) => {
		$crate::Hand::<10, 1>(
			$crate::Tile37CountedMultiSet::new(&$crate::t![$t1, $t2, $t3, $t4, $t5, $t6, $t7, $t8, $t9, $t10]),
			[
				$crate::make_hand!(@meld $m1),
			],
		)
	...
	($t1:tt $t2:tt $t3:tt $t4:tt $t5:tt $t6:tt $t7:tt $t8:tt $t9:tt $t10:tt $t11:tt $t12:tt $t13:tt) => {
		$crate::Hand::<13, 0>(
			$crate::Tile37CountedMultiSet::new(&$crate::t![$t1, $t2, $t3, $t4, $t5, $t6, $t7, $t8, $t9, $t10, $t11, $t12, $t13]),
			[],
		)
	};
