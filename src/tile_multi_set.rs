	...
	TElement: const TileMultiSetElement,
{
	...
	let count_lo = (counts_lo[offset_i] >> (offset_b * 2)) & 0b11;
	let count_hi = (counts_hi[offset_i] >> offset_b) & 0b1;
	(count_hi << 2 | (count_lo as u8)) as usize
}

const fn tile_to_count_max_mut<'a, TElement>(
	tile: TElement::Tile,
	counts_lo: &'a mut [u16; TElement::N],
	counts_hi: &'a mut [u8; TElement::N],
) -> (U3x8Mut<'a>, usize)
where
	TElement: const TileMultiSetElement,
{
