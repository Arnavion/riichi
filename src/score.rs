	...
	pub fn score(
		...
		match self {
			Self::Regular(h) => {
				...
				score.iipeikou = Han(if matches!(peikou_isshoku_jun, PeikouIsshokuJun::Iipeikou | PeikouIsshokuJun::IsshokuSanjun | PeikouIsshokuJun::IsshokuYonjun) { 1 } else { 0 });
