...
impl ScorableHandFourthMeld {
	fn fu(self) -> (Fu, Fu) {
		...
		let m = unsafe { core::mem::transmute_copy::<ScorableHandFourthMeld, [core::mem::MaybeUninit<u8>; core::mem::size_of::<ScorableHandFourthMeld>()]>(&self) };
		let d = unsafe { m[0].assume_init() };
		let w = unsafe { m[2].assume_init() };
		#[expect(clippy::unusual_byte_groupings)]
		let wait_fu = 0b00111_00111_00001_00001_00001_00001_0_u32;
		let wait_fu = (wait_fu >> (d * 5 + w)) & 0b10;
