...
const impl SortingNetwork for [Tile; 3] {
	fn sort(&mut self) {
		minmax!(self, 0, 2);
		minmax!(self, 0, 1);
		minmax!(self, 1, 2);
...
const impl SortingNetwork for [Tile; 4] {
	fn sort(&mut self) {
		minmax!(self, 0, 2);
		minmax!(self, 1, 3);
		minmax!(self, 0, 1);
...
const impl SortingNetwork for [Tile; 5] {
	fn sort(&mut self) {
		minmax!(self, 0, 3);
		minmax!(self, 1, 4);
		minmax!(self, 0, 2);
...
const impl SortingNetwork for [NumberTile; 3] {
	fn sort(&mut self) {
		minmax!(self, 0, 2);
		minmax!(self, 0, 1);
		minmax!(self, 1, 2);
