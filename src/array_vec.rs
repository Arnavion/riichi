...
/// A sequence of contiguous elements like a `Vec`, but backed by a fixed-length array.
///
/// An `ArrayVec` thus has a concept of being full, and pushing into a full `ArrayVec` fails.
pub struct ArrayVec<T, CAPACITY>
where
...
impl<T, CAPACITY> ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
	...
	pub fn push(&mut self, element: T) -> Result<(), T> {
		...
		if let Some(slot) = self.inner.get_mut(self.len) {
			slot.write(element);
			self.len += 1;
			Ok(())
		}
...
impl<T, CAPACITY> Clone for ArrayVec<T, CAPACITY>
where
	T: Clone,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> core::fmt::Debug for ArrayVec<T, CAPACITY>
where
	T: core::fmt::Debug,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> core::ops::Deref for ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
	type Target = [T];
...
impl<T, CAPACITY> core::ops::DerefMut for ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> Drop for ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
	fn drop(&mut self) {
...
impl<T, CAPACITY> Extend<T> for ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> FromIterator<T> for ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> IntoIterator for ArrayVec<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> PartialEq for ArrayVec<T, CAPACITY>
where
	T: PartialEq,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY, const N: usize> PartialEq<[T; N]> for ArrayVec<T, CAPACITY>
where
	T: PartialEq,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> Eq for ArrayVec<T, CAPACITY>
where
	T: Eq,
	CAPACITY: ArrayLength,
{}

impl<T, N, CAPACITY> TryFrom<GenericArray<T, N>> for ArrayVec<T, CAPACITY>
where
	N: ArrayLength,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY, N> TryFrom<ArrayVec<T, CAPACITY>> for GenericArray<T, N>
where
	CAPACITY: ArrayLength,
	N: ArrayLength,
{
...
pub struct ArrayVecIntoIter<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
	inner: GenericArray<core::mem::MaybeUninit<T>, CAPACITY>,
...
impl<T, CAPACITY> Clone for ArrayVecIntoIter<T, CAPACITY>
where
	T: Clone,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> core::fmt::Debug for ArrayVecIntoIter<T, CAPACITY>
where
	T: core::fmt::Debug,
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> Drop for ArrayVecIntoIter<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
	fn drop(&mut self) {
...
impl<T, CAPACITY> Iterator for ArrayVecIntoIter<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
	type Item = T;
...
impl<T, CAPACITY> DoubleEndedIterator for ArrayVecIntoIter<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{
...
impl<T, CAPACITY> ExactSizeIterator for ArrayVecIntoIter<T, CAPACITY>
where
	CAPACITY: ArrayLength,
{}
...
unsafe fn clone_inner<T, CAPACITY>(src: &GenericArray<core::mem::MaybeUninit<T>, CAPACITY>, len: usize) -> GenericArray<core::mem::MaybeUninit<T>, CAPACITY>
where
	T: Clone,
	CAPACITY: ArrayLength,
{
...
unsafe fn deref_inner<T, CAPACITY>(arr: &GenericArray<core::mem::MaybeUninit<T>, CAPACITY>, len: usize) -> &[T]
where
	CAPACITY: ArrayLength,
{
...
const unsafe fn take_inner<T, CAPACITY>(arr: &mut ArrayVec<T, CAPACITY>) -> (GenericArray<core::mem::MaybeUninit<T>, CAPACITY>, usize)
where
	CAPACITY: ArrayLength,
{
