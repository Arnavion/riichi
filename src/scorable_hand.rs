...
impl ScorableHandMeld {
	...
	fn chanta_routou(self) -> ChantaRoutou {
		match self {
			...
			Self::Minkan([t, ..]) |
			Self::Ankou([t, ..]) |
			Self::Minkou([t, ..]) => match t {
				t!(1m | 1p | 1s | 9m | 9p | 9s) => ChantaRoutou::all_terminals(),
				t!(E | S | W | N | Wh | G | R) => ChantaRoutou::all_honors(),
				_ => ChantaRoutou::other(),
			},

			Self::Anjun([t, ..]) |
			Self::Minjun([t, ..]) => match t {
				tn!(1m | 1p | 1s | 7m | 7p | 7s) => ChantaRoutou::has_terminals(),
				_ => ChantaRoutou::other(),
			},
		}
	}
...
impl Ord for ScorableHandMeld {
	fn cmp(&self, other: &Self) -> core::cmp::Ordering {
		...
		.then_with(|| {
			...
			ScorableHandMeldDiscriminant::from(self).cmp(&ScorableHandMeldDiscriminant::from(other))
		})
	}
}
...
impl Ord for ScorableHandFourthMeld {
	fn cmp(&self, other: &Self) -> core::cmp::Ordering {
		...
		#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd)]
		enum ScorableHandFourthMeldDiscriminant {
			Kanchan(TsumoOrRon),
			Penchan(TsumoOrRon),
			RyanmenLeft(TsumoOrRon),
			RyanmenRight(TsumoOrRon),
			Shanpon(TsumoOrRon),
		}
		...
		const impl From<&ScorableHandFourthMeld> for ScorableHandFourthMeldDiscriminant {
			...
			fn from(m: &ScorableHandFourthMeld) -> Self {
				match *m {
					...
					ScorableHandFourthMeld::Kanchan { tsumo_or_ron, .. } => Self::Kanchan(tsumo_or_ron),
					ScorableHandFourthMeld::Penchan { tsumo_or_ron, .. } => Self::Penchan(tsumo_or_ron),
					ScorableHandFourthMeld::RyanmenLeft { tsumo_or_ron, .. } => Self::RyanmenLeft(tsumo_or_ron),
					ScorableHandFourthMeld::RyanmenRight { tsumo_or_ron, .. } => Self::RyanmenRight(tsumo_or_ron),
					ScorableHandFourthMeld::Shanpon { tsumo_or_ron, .. } => Self::Shanpon(tsumo_or_ron),
				}
			}
		}

		let (this_discriminant, other_discriminant) = match (self, other) {
			...
			(this, other) => (
				ScorableHandFourthMeldDiscriminant::from(this),
				ScorableHandFourthMeldDiscriminant::from(other),
			),
		};
		let (t1, t2) = match *self {
			...
			Self::RyanmenLeft { tiles: [t1, t2, _], .. } |
			Self::RyanmenRight { tiles: [t1, t2, _], .. } => (t1.into(), t2.into()),
		...
		t1.cmp(&t_other1)
		.then_with(|| t2.cmp(&t_other2))
		.then_with(|| this_discriminant.cmp(&other_discriminant))
	}
}
...
impl ChantaRoutou {
	const fn has_terminals() -> Self { Self(0b0011) }
	const fn all_terminals() -> Self { Self(0b0001) }
	const fn all_honors() -> Self { Self(0b0100) }
	const fn other() -> Self { Self(0b1000) }

	// Has terminals and honors
	pub(crate) const fn is_chanta(self) -> bool { self.0 == 0b0111 }
	// Has terminals
	pub(crate) const fn is_junchan(self) -> bool { self.0 == 0b0011 }
	// All terminals and honors
	pub(crate) const fn is_honroutou(self) -> bool { self.0 == 0b0101 }
	// All terminals
	pub(crate) const fn is_chinroutou(self) -> bool { self.0 == 0b0001 }
	// All honors
	pub(crate) const fn is_tsuuiisou(self) -> bool { self.0 == 0b0100 }
	// Others
	#[cfg(test)]
	const fn is_other(self) -> bool { self.0 >= 0b1000 }
}
...
const fn make_junsei_chuuren_poutou_hands(suit: NumberSuit) -> [ScorableHand; 27] {
	...
	[
		...
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n2, n3, n4]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n4, n5, n6], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t9, t9]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n2, n3, n4]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n4, n5, n6], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t9, t9]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n2, n3, n4]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n5, n6, n7], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t9, t9]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n2, n3, n4]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n5, n6, n7], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t9, t9]) },
		...
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n1, n2, n3], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t9, t9]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n1, n2, n3], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t9, t9]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n2, n3, n4], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t9, t9]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Ankou([t1, t1, t1]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Anjun([n7, n8, n9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n2, n3, n4], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t9, t9]) },
		...
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n6, n7, n8], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n6, n7, n8], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n7, n8, n9], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n4, n5, n6]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n7, n8, n9], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n6, n7, n8]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n3, n4, n5], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n6, n7, n8]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenLeft { tiles: [n3, n4, n5], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n6, n7, n8]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n4, n5, n6], tsumo_or_ron: TsumoOrRon::Tsumo }), pair: ScorableHandPair([t1, t1]) },
		ScorableHand::Regular { melds: ([ScorableHandMeld::Anjun([n1, n2, n3]), ScorableHandMeld::Anjun([n6, n7, n8]), ScorableHandMeld::Ankou([t9, t9, t9])], ScorableHandFourthMeld::RyanmenRight { tiles: [n4, n5, n6], tsumo_or_ron: TsumoOrRon::Ron }), pair: ScorableHandPair([t1, t1]) },
...
mod tests {
	...
	fn chanta_routou() {
		...
		const EXPECTED_JUNCHAN: (bool, bool, bool, bool, bool, bool) = (false, true, false, false, false, false);
		const EXPECTED_HONROUTOU: (bool, bool, bool, bool, bool, bool) = (false, false, true, false, false, false);
		const EXPECTED_CHINROUTOU: (bool, bool, bool, bool, bool, bool) = (false, false, false, true, false, false);
		const EXPECTED_TSUUIISOU: (bool, bool, bool, bool, bool, bool) = (false, false, false, false, true, false);
		...
		for (input_lhs, input_rhs, expected) in [
			...
			let actual = (actual.is_chanta(), actual.is_junchan(), actual.is_honroutou(), actual.is_chinroutou(), actual.is_tsuuiisou(), actual.is_other());
