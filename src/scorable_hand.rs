...
impl ScorableHandRegular {
	pub fn new(ma: ScorableHandMeld, mb: ScorableHandMeld, mc: ScorableHandMeld, md: ScorableHandFourthMeld, pair: ScorableHandPair) -> Self {
		...
		Self { pair: ScorableHandRegularPair { tag: ScorableHandRegularPairTag::Pair, inner: pair }, m1, m2, m3, m4 }
	}
			...
			all(target_arch = "riscv64", target_feature = "v") => {
				...
				unsafe {
					core::arch::asm!(
						...
						// let kan_kou_honors_contains_t /* : v0:v0 */ = (masks & Tile34Set::HONORS) != 0;
						"vsetvli zero, zero, e64, m4, ta, ma",
						...
						// let kan_kou_terminals_contains_t /* : v0:v0 */ = (masks & Tile34Set::TERMINALS) != 0;
						"vsetvli zero, zero, e64, m4, ta, ma",
						...
						kan_kou_terminals = in(reg) Tile34Set::TERMINALS.present,
						kan_kou_honors = in(reg) Tile34Set::HONORS.present,
...
impl core::fmt::Display for ScorableHandRegular {
	fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
		let Self { pair, m1, m2, m3, m4 } = self;
