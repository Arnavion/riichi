...
impl ScorableHandRegular {
	...
	pub(crate) fn num_peikou_isshoku_sanjun(&self) -> (usize, bool) {
		...
		// The SWAR impl generates smaller code for targets without vectorization.
		cfg_select! {
			use_core_simd => {
				let consider = core::simd::cmp::SimdPartialEq::simd_eq(
					ds & core::simd::Simd::splat(0x04),
			...
			_ => {
				...
				let consider = core::simd::cmp::SimdPartialEq::simd_eq(ds & core::simd::Simd::splat(0b100), core::simd::Simd::splat(4));
	...
	pub(crate) fn chanta_routou(&self) -> ChantaRoutou {
		...
		let kou_kan_honors = core::simd::Simd::splat(Tile34Set::HONORS.present);
		...
		let kou_kan_terminals = core::simd::Simd::splat(Tile34Set::TERMINALS.present);
...
impl ScorableHandChiitoi {
	...
	pub(crate) fn chanta_routou(self) -> ChantaRoutou {
		...
		let honors = core::simd::Simd::splat(Tile34Set::HONORS.present);
		...
		let terminals = core::simd::Simd::splat(Tile34Set::TERMINALS.present);
