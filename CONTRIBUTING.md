...
RV+v: `--edition 2024 -C opt-level=3 --target riscv64gc-unknown-linux-gnu -C target-feature=+b,+zca,+zcb,+zicond -Z llvm-target-feature=+v,+zvbb -C unsafe-allow-abi-mismatch=llvm-target-feature`
